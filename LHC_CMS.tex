...
%Change discussion on silicon tracker not accurate maybe find paper to read up on it. It tracks more momentum of charged particles as it goes through the magnetic field
%Change discussion of ECAL just really electrons and photons
%HF does not use scintillator but quartz fiber. Reword different things to make sense when talking about HCAL not making sense
%scinitillator tiles reword particle interaction description
%get rid of wording "despositing light"
%Change description of muons more direct less word play 
%more accurate description in the final sentences no thisss
