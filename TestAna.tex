...
%add in discussion of muon vs. pion data. Show more charge distirbutions ... more content is good
...
\caption{These plots show the recreation of an event with 50\GeV pions showing the pions aimed at iphi 5 ieta 19 and the energy deposited in each channel z scale in \MeV. The different plots show different iphi locations.}
\label{fig:pionmap}
\end{figure}
...
\caption{Fitted pulse shapes of using events of charge 10,000-29,000 fC (A) and 29,000-50,000 fC (B)}
